...
export default function App() {
  ...
  return <>
    ...
    <main>
      <div className="intro"><h1>让讨论留下重点。</h1><p>实时记录每一句话，持续整理会议脉络。</p></div>
      ...
      <Panels meeting={meeting} state={state} interval={settings?.summary_interval ?? 30} onSummarize={() => void summarize()}/>
